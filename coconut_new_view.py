...
model = YOLO(r"C:\Users\venka\Downloads\coconut (4)\coconut\coconut\runs\classify\train15")

# 2. Path to the test image
img_path = r"C:\Users\venka\Downloads\coconut (4)\coconut\coconut\view\train\side\IMG-20250912-WA0228.jpg"
