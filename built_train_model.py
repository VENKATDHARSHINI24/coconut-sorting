...
# ---- Load Labels CSV ----
labels = pd.read_csv(r"C:\Users\venka\Downloads\coconut (4)\coconut\coconut\coconut_dataset_with_features.csv")
...
for _, row in labels.iterrows():
    ...
    img_path = os.path.join(
        r"C:\Users\venka\Downloads\coconut (4)\coconut\coconut\weightcalculation",
        img_name
    )
...
df.to_csv(r"C:\Users\venka\Downloads\coconut (4)\coconut\coconut\coconut_dataset_with_features.csv", index=False)
